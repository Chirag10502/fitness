...
var func = async () => {
  var users = await fetch("http://localhost:5000/getUser");
...
var duePayment = async () => {
  var users = await fetch("http://localhost:5000/duePayment");
  users = await users.json();
  console.log(users);
  users.map((item) => {
    var tr = document.createElement("tr");
...
var alldata = async () => {
  var users = await fetch("http://localhost:5000/allUser");
